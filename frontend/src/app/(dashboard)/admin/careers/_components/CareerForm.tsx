  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-2 sm:col-span-2">
            <input
              ...
              onChange={handleChange}
              className="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-white/10 dark:bg-white/5"
            />
      ...
      <div className="rounded-md border border-gray-200 bg-white p-6 dark:border-white/5 dark:bg-white/3">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center font-medium gap-2 rounded-lg transition px-4 py-3 text-sm bg-white text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/3 dark:hover:text-gray-300"
          >
          ...
          {requirements.map((req, index) => (
            <div key={index} className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-white/10 dark:bg-white/5 dark:text-white"
              />
              <button
                type="button"
                onClick={() => removeArrayItem(index, requirements, setRequirements)}
                disabled={requirements.length === 1}
                className="rounded p-2 text-error-500 hover:bg-error-50 disabled:opacity-50 dark:hover:bg-error-500/10"
              >
      ...
      <div className="flex justify-end gap-3">
        ...
        >
          {isSubmitting ? 'Saving...' : careerId ? 'Update Career' : 'Create Career'}
        </button>
      </div>
    </form>
  );
