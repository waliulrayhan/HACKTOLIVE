...
import { productService, categoryService, ProductCategory, Product } from '@/lib/shop-service';
    ...
    const fetchProduct = async () => {
        try {
            ...
            setFormData({
                ...
                voucherDuration: product.voucherDuration ? Math.round(product.voucherDuration / 30) : 1, // Convert days to months
                sizes: product.sizes || [],
                    ...
                    {steps.map((step, index) => (
                        <React.Fragment key={step.number}>
                            <div className="flex flex-col items-center min-w-0">
                                <div
                                    className={`flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-full border-2 transition-all duration-200 ${currentStep >= step.number
                                ...
                                <p className={`mt-2 text-[10px] sm:text-xs font-medium text-center ${currentStep >= step.number
                            ...
                            {index < steps.length - 1 && (
                                <div
                                    className={`h-0.5 flex-1 mx-2 sm:mx-4 transition-colors ${currentStep > step.number
                                            ? 'bg-brand-500'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className={`w-full h-10 rounded-lg border px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 ${errors.name
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            value={formData.slug}
                                            onChange={handleInputChange}
                                            className={`w-full h-10 rounded-lg border pl-10 pr-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 ${errors.slug
                                                    ? 'border-red-500 focus:border-red-500'
                                                    : 'border-gray-300 focus:border-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white'
                                                }`}
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full h-10 rounded-lg border px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:bg-gray-800 dark:text-white ${errors.categoryId
                                                ? 'border-red-500 focus:border-red-500'
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        rows={6}
                                        className={`w-full rounded-lg border px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 ${errors.description
                                                ? 'border-red-500 focus:border-red-500'
                                                : 'border-gray-300 focus:border-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white'
                                            }`}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                    Update pricing and manage stock levels
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        step="0.01"
                                        className={`w-full h-10 rounded-lg border px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 ${errors.price
                                                ? 'border-red-500 focus:border-red-500'
                                                : 'border-gray-300 focus:border-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white'
                                            }`}
                                    />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        min="0"
                                        className={`w-full h-10 rounded-lg border px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/20 ${errors.stockQuantity
                                                ? 'border-red-500 focus:border-red-500'
                                                : 'border-gray-300 focus:border-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white'
                                            }`}
                                    />
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                    Review all changes before updating the product
                                </p>
                            </div>
                        </div>
