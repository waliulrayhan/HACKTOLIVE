...
export default function BlogsManagementPage() {
  ...
  const fetchBlogs = useCallback(async () => {
    ...
    try {
      ...
      // Filter to only show instructor's own blogs
  ...
  const handleEditBlog = (blogId: string) => {
    router.push(`/instructor/blogs/${blogId}/edit`);
  };

  const handleCreateBlog = () => {
    router.push('/instructor/blogs/create');
  };
  ...
  const getCategoryBadgeClass = (category: string) => {
    const colors: Record<string, string> = {
      CYBERSECURITY_BASICS: 'bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-400',
      ETHICAL_HACKING: 'bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-400',
      PENETRATION_TESTING: 'bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-400',
      KALI_LINUX_AND_LINUX_SECURITY: 'bg-orange-100 text-orange-700 dark:bg-orange-500/15 dark:text-orange-400',
      CYBERSECURITY_TOOLS: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-500',
      NETWORKING_AND_NETWORK_SECURITY: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-500/15 dark:text-cyan-400',
      WEB_APPLICATION_SECURITY: 'bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-400',
      MOBILE_SECURITY: 'bg-pink-100 text-pink-700 dark:bg-pink-500/15 dark:text-pink-400',
      CLOUD_SECURITY: 'bg-sky-100 text-sky-700 dark:bg-sky-500/15 dark:text-sky-400',
      DIGITAL_FORENSICS: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-400',
      CYBER_THREATS_AND_ATTACKS: 'bg-red-100 text-red-800 dark:bg-red-500/15 dark:text-red-300',
      MALWARE_AND_RANSOMWARE: 'bg-red-100 text-red-800 dark:bg-red-500/15 dark:text-red-300',
      PRIVACY_AND_ONLINE_SAFETY: 'bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-400',
      CRYPTOGRAPHY: 'bg-purple-100 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400',
      PROGRAMMING_FOR_CYBERSECURITY: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400',
      INCIDENT_RESPONSE_AND_SOC: 'bg-blue-100 text-blue-800 dark:bg-blue-500/15 dark:text-blue-300',
      RED_TEAMING: 'bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-400',
      BLUE_TEAMING: 'bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-400',
      SECURITY_CERTIFICATIONS: 'bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-400',
      CAREER_GUIDES: 'bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-400',
      CYBERSECURITY_NEWS_AND_UPDATES: 'bg-gray-100 text-gray-700 dark:bg-gray-500/15 dark:text-gray-400',
      VULNERABILITIES_AND_EXPLOITS: 'bg-orange-100 text-orange-800 dark:bg-orange-500/15 dark:text-orange-300',
      SECURITY_BEST_PRACTICES: 'bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-400',
      OSINT_OPEN_SOURCE_INTELLIGENCE: 'bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-400',
      IOT_SECURITY: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-500/15 dark:text-cyan-300',
      AI_IN_CYBERSECURITY: 'bg-violet-100 text-violet-800 dark:bg-violet-500/15 dark:text-violet-300',
      CLOUD_AND_DEVSECOPS: 'bg-sky-100 text-sky-800 dark:bg-sky-500/15 dark:text-sky-300',
      SECURITY_TOOLS_TUTORIALS: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-500/15 dark:text-yellow-400',
      CTF_WALKTHROUGHS_AND_LABS: 'bg-lime-100 text-lime-700 dark:bg-lime-500/15 dark:text-lime-400',
      GUIDES_AND_STEP_BY_STEP_TUTORIALS: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-300',
      CYBERSECURITY_INSIGHTS: 'bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-500',
      NEWS: 'bg-purple-100 text-purple-700 dark:bg-purple-500/15 dark:text-purple-500',
      TUTORIALS: 'bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-500',
    };
