                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                              ...
                              <button
                                onClick={() => {
                                  updateModule(module.id, {
                                    isVisibleForMarketing: !module.isVisibleForMarketing
                                  });
                                }}
                                disabled={savingModule === module.id}
                                className={`inline-flex items-center gap-1 sm:gap-1.5 h-7 sm:h-8 rounded-lg border px-2 sm:px-3 text-xs font-medium transition-colors ${
                                  module.isVisibleForMarketing
                                ...
                                title="Toggle visibility for marketing preview"
                              >
                                {savingModule === module.id ? (
                                  <>
                                ...
                                <span className="hidden sm:inline">{module.isVisibleForMarketing ? 'Preview On' : 'Preview Off'}</span>
                              </button>
                              <button
