    ...
    const fetchBlogs = async () => {
      ...
      try {
        ...
        const categoryMap: Record<string, string> = {
          ...
          'KALI_LINUX_AND_LINUX_SECURITY': 'Kali Linux & Linux Security',
          'CYBERSECURITY_TOOLS': 'Cybersecurity Tools',
          'NETWORKING_AND_NETWORK_SECURITY': 'Networking & Network Security',
          'WEB_APPLICATION_SECURITY': 'Web Application Security',
          'MOBILE_SECURITY': 'Mobile Security',
          'CLOUD_SECURITY': 'Cloud Security',
          'DIGITAL_FORENSICS': 'Digital Forensics',
          'CYBER_THREATS_AND_ATTACKS': 'Cyber Threats & Attacks',
          'MALWARE_AND_RANSOMWARE': 'Malware & Ransomware',
          'PRIVACY_AND_ONLINE_SAFETY': 'Privacy & Online Safety',
          'CRYPTOGRAPHY': 'Cryptography',
          'PROGRAMMING_FOR_CYBERSECURITY': 'Programming for Cybersecurity',
          'INCIDENT_RESPONSE_AND_SOC': 'Incident Response & SOC',
          'RED_TEAMING': 'Red Teaming',
          'BLUE_TEAMING': 'Blue Teaming',
          'SECURITY_CERTIFICATIONS': 'Security Certifications',
          'CAREER_GUIDES': 'Career Guides',
          'CYBERSECURITY_NEWS_AND_UPDATES': 'Cybersecurity News & Updates',
          'VULNERABILITIES_AND_EXPLOITS': 'Vulnerabilities & Exploits',
          'SECURITY_BEST_PRACTICES': 'Security Best Practices',
          'OSINT_OPEN_SOURCE_INTELLIGENCE': 'OSINT (Open-Source Intelligence)',
          'IOT_SECURITY': 'IoT Security',
          'AI_IN_CYBERSECURITY': 'AI in Cybersecurity',
          'CLOUD_AND_DEVSECOPS': 'Cloud & DevSecOps',
          'SECURITY_TOOLS_TUTORIALS': 'Security Tools Tutorials',
          'CTF_WALKTHROUGHS_AND_LABS': 'CTF Walkthroughs & Labs',
          'GUIDES_AND_STEP_BY_STEP_TUTORIALS': 'Guides & Step-by-Step Tutorials',
