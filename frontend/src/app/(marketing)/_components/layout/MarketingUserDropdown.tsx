  ...
  return (
    <div className="relative hidden md:block">
      ...
      >
        ...
        <span className="hidden md:block mr-1 font-medium text-xs">
          {user?.name || 'User'}
        </span>
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-3 flex w-56 flex-col rounded-xl border border-gray-200 bg-white p-2.5 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
