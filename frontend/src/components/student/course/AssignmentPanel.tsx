    ...
    <>
      <div className="space-y-6">
        ...
        <div className="rounded-md border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.03] overflow-hidden">
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/10 dark:to-amber-900/10 border-b border-gray-200 dark:border-white/5 px-6 py-4">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-orange-100 dark:bg-orange-900/30">
                <HiOutlineClipboardCheck className="h-6 w-6 text-orange-600 dark:text-orange-400" />
              </div>
          ...
          <div className="p-6">
            ...
            {assignment.instructions && (
              <div className="mb-6 p-4 rounded-lg bg-info-50 dark:bg-info-900/20 border border-info-200 dark:border-info-800/50">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5">
        ...
        {/* Submission Section */}
        {!submission ? (
          <div className="rounded-md border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.03] p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-white/5 px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none transition-all resize-none"
          ...
          <div className="rounded-md border-2 border-warning-200 dark:border-warning-800/50 bg-warning-50 dark:bg-warning-900/20 p-6">
            <div className="flex items-start gap-4">
          ...
          <div className="rounded-md border-2 border-success-200 dark:border-success-800/50 bg-success-50 dark:bg-success-900/20 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-success-100 dark:bg-success-900/30">
                  <HiOutlineStar className="h-6 w-6 text-success-600 dark:text-success-400" />
                </div>
                <div>
                  <h4 className="text-lg font-bold text-success-900 dark:text-success-300">
                    Assignment Graded
                  </h4>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
            <div className="p-6">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Once submitted, you cannot edit your assignment. Make sure you have reviewed your work.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 mb-6">
                ...
                {submissionUrl && (
                  <p className="text-sm text-brand-600 dark:text-brand-400 truncate">
                    📎 {submissionUrl}
                  </p>
                )}
              </div>
